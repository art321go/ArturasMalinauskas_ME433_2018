package com.example.arturas.androidcamera;
...
public class MainActivity extends Activity implements TextureView.SurfaceTextureListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myTextView.setText("Slider is working!");
    ...
    public void setMyControlListener() {
        myControl.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            @Override
            public void onProgressChanged(SeekBar seekBar, int slider, boolean fromUser) {
                Threshhold = slider;
                myTextView.setText("The value is: "+slider);
            }
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        if (c != null) {
            int thresh = Threshhold; // comparison value
            int[] pixels = new int[bmp.getWidth()]; // pixels[] is the RGBA data
            int startY = 200; // which row in the bitmap to analyze to read

            for (int yy = 0; yy < bmp.getHeight(); yy = yy + 3) {
                bmp.getPixels(pixels, 0, bmp.getWidth(), 0, yy, bmp.getWidth(), 1);
                ...
                // update the row
                bmp.setPixels(pixels, 0, bmp.getWidth(), 0, yy, bmp.getWidth(), 1);
            }
        }
